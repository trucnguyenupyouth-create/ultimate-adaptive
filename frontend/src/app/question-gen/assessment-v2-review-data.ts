// Generated from /Users/admin/Downloads/assessment_v2_generated_items_academic_review.md plus Codex-authored supplemental pilot fixtures.
// AI/Codex draft data for local academic review UI. Do not treat as approved item bank data.

export type V2CommonWrongPattern = {
  pattern: string;
  mode?: string;
  diagnosis: string;
...
export type V2GapRecord = Record<string, unknown> & { cluster: string };

export const assessmentV2ReviewItems: V2ReviewItem[] = [
  {
    ...
    "cluster": "Fractions Equivalence và Operations",
    "review_id": "v2-001",
    "codex_review_status": "needs_academic_review",
    "action_notes": [
      {
        "action": "codex_imported_from_academic_review_file",
        "note": "Giữ nguyên AI draft ban đầu để academic team review; không đánh dấu academic_reviewed.",
        "concern": "Tất cả AI drafts vẫn cần reviewer xác nhận primary KC, requires_kcs, diagnoses_kcs và inference strength."
      },
      {
        "action": "codex_flagged_for_structured_redesign",
        "note": "Item short_text nên được đổi sang binary/set/expression structured input nếu muốn auto-grade chắc hơn.",
        "concern": "Nếu giữ short_text, cần rubric và normalization rõ trước khi dùng trong algorithm test."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "cluster": "Decimals, Percent, Ratio",
    "review_id": "v2-008",
    "codex_review_status": "needs_academic_review",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Expressions & Order of Operations",
    "review_id": "v2-013",
    "codex_review_status": "needs_academic_review",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Number Foundations & Divisibility",
    "review_id": "v2-022",
    "codex_review_status": "needs_academic_review",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Data / Statistics / Probability, Non-Visual",
    "review_id": "v2-027",
    "codex_review_status": "needs_academic_review",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "common_wrong_patterns": [
      {
        "pattern": "15/20",
        "mode": "exact",
        "diagnosis": "Rút gọn chưa tới dạng tối giản",
        "diagnoses_kcs": [
          "959461db-e6ce-44b6-8c5f-25c65ac467e8"
        ]
      },
      {
        "pattern": "45/60",
        "mode": "exact",
        "diagnosis": "Không thực hiện rút gọn",
        "diagnoses_kcs": [
          "959461db-e6ce-44b6-8c5f-25c65ac467e8"
        ]
      }
    ...
    "action_notes": [
      {
        "action": "codex_self_added",
        "note": "Tự thêm để tăng item-bank pilot fixture cho deterministic Assessment V2 algorithm tests; chưa đưa vào production DB.",
        "concern": "Cần academic review trước khi dùng với học sinh thật hoặc nâng inference_strength."
      },
      {
        "action": "codex_provisionally_accepted_for_algorithm_fixture",
        "note": "Có thể dùng trong test heuristic nội bộ vì answer_type/accepted_answers/common_wrong_patterns đã explicit.",
        "concern": "Không phải academic approval; reviewer vẫn có thể reject hoặc chỉnh KC mapping."
      }
    ]
  },
  {
    ...
    "cluster": "Fractions Equivalence và Operations",
    "kc_id": "93a0e693-56a1-4140-bbb5-6f27cd2c155b",
    "question": "Quy đồng mẫu hai phân số 5/6 và 7/9 bằng mẫu chung nhỏ nhất. Viết theo dạng {phân số thứ nhất; phân số thứ hai}.",
    "answer_type": "set",
    "accepted_answers": [
      "15/18;14/18"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "45/54;42/54",
        "mode": "exact",
        "diagnosis": "Dùng mẫu chung nhưng chưa phải mẫu chung nhỏ nhất",
        "diagnoses_kcs": [
          "93a0e693-56a1-4140-bbb5-6f27cd2c155b"
        ]
      },
      {
        "pattern": "5/54;7/54",
        "mode": "exact",
        "diagnosis": "Đổi mẫu nhưng không nhân tử số tương ứng",
        "diagnoses_kcs": [
          "93a0e693-56a1-4140-bbb5-6f27cd2c155b"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "4/15",
        "mode": "exact",
        "diagnosis": "Cộng tử và mẫu trực tiếp",
        "diagnoses_kcs": [
          "cdb87133-898d-431e-9155-b17dacb8d6dd"
        ]
      },
      {
        "pattern": "4/10",
        "mode": "exact",
        "diagnosis": "Không đổi 3/5 về mẫu 10 trước khi cộng",
        "diagnoses_kcs": [
          "cdb87133-898d-431e-9155-b17dacb8d6dd"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "6/4",
        "mode": "exact",
        "diagnosis": "Trừ tử số nhưng giữ mẫu của phân số thứ hai",
        "diagnoses_kcs": [
          "cdb87133-898d-431e-9155-b17dacb8d6dd"
        ]
      },
      {
        "pattern": "6/8",
        "mode": "exact",
        "diagnosis": "Không đổi 1/4 thành 2/8 trước khi trừ",
        "diagnoses_kcs": [
          "cdb87133-898d-431e-9155-b17dacb8d6dd"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Fractions Equivalence và Operations",
    "kc_id": "d0d94d7e-8b74-4648-a31e-a722b86957d3",
    "question": "Tính: 5/6 × 3/10 và rút gọn kết quả.",
    "answer_type": "fraction",
    "accepted_answers": [
      "1/4"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "15/60",
        "mode": "exact",
        "diagnosis": "Nhân đúng nhưng chưa rút gọn",
        "diagnoses_kcs": [
          "d0d94d7e-8b74-4648-a31e-a722b86957d3"
        ]
      },
      {
        "pattern": "8/16",
        "mode": "exact",
        "diagnosis": "Cộng tử/mẫu thay vì nhân",
        "diagnoses_kcs": [
          "d0d94d7e-8b74-4648-a31e-a722b86957d3"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "27/40",
        "mode": "exact",
        "diagnosis": "Nhân với phân số chia thay vì nhân với nghịch đảo",
        "diagnoses_kcs": [
          "d0d94d7e-8b74-4648-a31e-a722b86957d3"
        ]
      },
      {
        "pattern": "30/36",
        "mode": "exact",
        "diagnosis": "Có dùng nghịch đảo nhưng chưa rút gọn",
        "diagnoses_kcs": [
          "d0d94d7e-8b74-4648-a31e-a722b86957d3"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Fractions Equivalence và Operations",
    "kc_id": "0164cf7c-e080-4ca0-909b-e292f65af633",
    "question": "Hai phân số 14/21 và 2/3 có bằng nhau không? Trả lời có hoặc không.",
    "answer_type": "short_text",
    "accepted_answers": [
      "có",
      "co",
    ...
    "common_wrong_patterns": [
      {
        "pattern": "không",
        "mode": "contains",
        "diagnosis": "So sánh hình thức tử/mẫu thay vì rút gọn hoặc nhân chéo",
        "diagnoses_kcs": [
          "0164cf7c-e080-4ca0-909b-e292f65af633"
        ]
      }
    ...
    "flags": [
      "codex concern: nên đổi thành binary input Có/Không để tránh short_text tự do."
    ],
    "codex_review_status": "provisionally_accepted_for_algorithm_test_only",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Fractions Equivalence và Operations",
    "kc_id": "b68ce985-f530-48eb-9151-e880cf5a61fb",
    "question": "Trong các cách viết sau: -6/11, 4/0, 0/5. Cách viết nào không phải phân số hợp lệ?",
    "answer_type": "short_text",
    "accepted_answers": [
      "4/0",
      "4/0 vì mẫu bằng 0",
      "4/0 vì mẫu số bằng 0"
    ],
    "tolerance": null,
    "difficulty_label": "anchor",
    "is_diagnostic_anchor": true,
    ...
    "common_wrong_patterns": [
      {
        "pattern": "-6/11",
        "mode": "contains",
        "diagnosis": "Tưởng tử số âm thì không phải phân số",
        "diagnoses_kcs": [
          "b68ce985-f530-48eb-9151-e880cf5a61fb"
        ]
      },
      {
        "pattern": "0/5",
        "mode": "contains",
        "diagnosis": "Tưởng tử số bằng 0 thì không phải phân số",
        "diagnoses_kcs": [
          "b68ce985-f530-48eb-9151-e880cf5a61fb"
        ]
      }
    ...
    "flags": [
      "codex concern: nếu muốn deterministic grading, tách thành chọn invalid fraction + reason code."
    ],
    "codex_review_status": "provisionally_accepted_for_algorithm_test_only",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Decimals, Percent, Ratio",
    "kc_id": "b40bd888-5268-476f-bdc6-a6116fef1b16",
    "question": "Viết -35/10 dưới dạng số thập phân.",
    "answer_type": "decimal",
    "accepted_answers": [
      "-3.5",
      "-3,5"
    ...
    "common_wrong_patterns": [
      {
        "pattern": "3.5",
        "mode": "exact",
        "diagnosis": "Bỏ dấu âm khi đổi phân số thập phân",
        "diagnoses_kcs": [
          "b40bd888-5268-476f-bdc6-a6116fef1b16"
        ]
      },
      {
        "pattern": "-0.35",
        "mode": "exact",
        "diagnosis": "Sai vị trí dấu phẩy thập phân",
        "diagnoses_kcs": [
          "b40bd888-5268-476f-bdc6-a6116fef1b16"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "1.2",
        "mode": "exact",
        "diagnosis": "Sai dấu khi nhân hai số thập phân khác dấu",
        "diagnoses_kcs": [
          "cabfac64-e7dd-4074-99fa-aa240ffa4a80"
        ]
      },
      {
        "pattern": "-12",
        "mode": "exact",
        "diagnosis": "Sai vị trí dấu phẩy khi nhân thập phân",
        "diagnoses_kcs": [
          "cabfac64-e7dd-4074-99fa-aa240ffa4a80"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "-7",
        "mode": "exact",
        "diagnosis": "Sai dấu khi chia hai số thập phân cùng dấu âm",
        "diagnoses_kcs": [
          "cabfac64-e7dd-4074-99fa-aa240ffa4a80"
        ]
      },
      {
        "pattern": "0.7",
        "mode": "exact",
        "diagnosis": "Sai vị trí dấu phẩy khi chia thập phân",
        "diagnoses_kcs": [
          "cabfac64-e7dd-4074-99fa-aa240ffa4a80"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Decimals, Percent, Ratio",
    "kc_id": "5d32c8a0-841b-47ef-b75e-9cc64f527aaa",
    "question": "Một đoạn dây dài 1,2 m, đoạn dây khác dài 80 cm. Viết tỉ số độ dài đoạn thứ nhất so với đoạn thứ hai dưới dạng phân số tối giản.",
    "answer_type": "fraction",
    "accepted_answers": [
      "3/2"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "12/80",
        "mode": "exact",
        "diagnosis": "Không đổi cùng đơn vị trước khi lập tỉ số",
        "diagnoses_kcs": [
          "5d32c8a0-841b-47ef-b75e-9cc64f527aaa"
        ]
      },
    ...
    "common_wrong_patterns": [
      {
        "pattern": "25",
        "mode": "exact",
        "diagnosis": "Nhầm phần trăm với số lượng trực tiếp",
        "diagnoses_kcs": [
          "9e9c5789-2dce-4f16-a695-632cb9301923"
        ]
      },
      {
        "pattern": "480",
        "mode": "exact",
        "diagnosis": "Chia sai quan hệ phần trăm",
        "diagnoses_kcs": [
          "9e9c5789-2dce-4f16-a695-632cb9301923"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Decimals, Percent, Ratio",
    "kc_id": "2c3fda5a-55af-42de-b11b-72617bc45836",
    "question": "Một số khi lấy 40% thì được 18. Số đó là bao nhiêu?",
    "answer_type": "integer",
    "accepted_answers": [
      "45"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "7.2",
        "mode": "exact",
        "diagnosis": "Tính 40% của 18 thay vì tìm số gốc",
        "diagnoses_kcs": [
          "2c3fda5a-55af-42de-b11b-72617bc45836"
        ]
      },
      {
        "pattern": "72",
        "mode": "exact",
        "diagnosis": "Sai phép chia cho 0,4",
        "diagnoses_kcs": [
          "2c3fda5a-55af-42de-b11b-72617bc45836"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "112",
        "mode": "exact",
        "diagnosis": "Tính từ trái sang phải, bỏ qua thứ tự lũy thừa và nhân trước",
        "diagnoses_kcs": [
          "9c934457-4e43-4486-91da-61636059295c"
        ]
      },
      {
        "pattern": "52",
        "mode": "exact",
        "diagnosis": "Tính nhân trước nhưng chưa xử lý lũy thừa đúng",
        "diagnoses_kcs": [
          "9c934457-4e43-4486-91da-61636059295c"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "96",
        "mode": "exact",
        "diagnosis": "Bỏ qua ngoặc vuông/ngoặc tròn khi tính",
        "diagnoses_kcs": [
          "a75e022e-e78b-4020-a20b-45f3b0d995dd"
        ]
      },
      {
        "pattern": "12",
        "mode": "exact",
        "diagnosis": "Xử lý thiếu phép nhân trong ngoặc vuông",
        "diagnoses_kcs": [
          "a75e022e-e78b-4020-a20b-45f3b0d995dd"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Expressions & Order of Operations",
    "kc_id": "095f17d0-9860-4c78-9ad7-d93b1702af55",
    "question": "Viết kết quả dưới dạng một lũy thừa: 7³ · 7²",
    "answer_type": "short_text",
    "accepted_answers": [
      "7^5",
      "7⁵",
    ...
    "common_wrong_patterns": [
      {
        "pattern": "7^6",
        "mode": "contains",
        "diagnosis": "Nhân số mũ khi nhân hai lũy thừa cùng cơ số",
        "diagnoses_kcs": [
          "095f17d0-9860-4c78-9ad7-d93b1702af55"
        ]
      },
      {
        "pattern": "49^5",
        "mode": "contains",
        "diagnosis": "Nhân cơ số khi nhân lũy thừa cùng cơ số",
        "diagnoses_kcs": [
          "095f17d0-9860-4c78-9ad7-d93b1702af55"
        ]
      }
    ...
    "flags": [
      "codex concern: cần expression/power input; short_text chỉ là temporary fixture."
    ],
    "codex_review_status": "provisionally_accepted_for_algorithm_test_only",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Expressions & Order of Operations",
    "kc_id": "cb9cba24-5074-4b1c-8fb6-84ab98c03a4e",
    "question": "Viết kết quả dưới dạng một lũy thừa: 10⁷ : 10³",
    "answer_type": "short_text",
    "accepted_answers": [
      "10^4",
      "10⁴",
    ...
    "common_wrong_patterns": [
      {
        "pattern": "10^10",
        "mode": "contains",
        "diagnosis": "Cộng số mũ khi chia hai lũy thừa cùng cơ số",
        "diagnoses_kcs": [
          "cb9cba24-5074-4b1c-8fb6-84ab98c03a4e"
        ]
      },
      {
        "pattern": "1^4",
        "mode": "contains",
        "diagnosis": "Chia cơ số thay vì giữ cơ số",
        "diagnoses_kcs": [
          "cb9cba24-5074-4b1c-8fb6-84ab98c03a4e"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Expressions & Order of Operations",
    "kc_id": "7c147ca4-23b5-4563-be98-cd0b07af6f6e",
    "question": "Bỏ dấu ngoặc: 20 + (x - 7 + y). Viết biểu thức sau khi bỏ ngoặc.",
    "answer_type": "short_text",
    "accepted_answers": [
      "20 + x - 7 + y",
      "20+x-7+y"
    ...
    "common_wrong_patterns": [
      {
        "pattern": "20 - x + 7 - y",
        "mode": "contains",
        "diagnosis": "Đổi dấu các hạng tử dù trước ngoặc là dấu cộng",
        "diagnoses_kcs": [
          "7c147ca4-23b5-4563-be98-cd0b07af6f6e"
        ]
      }
    ...
    "flags": [
      "codex concern: cần expression normalization trước khi auto-grade."
    ],
    "codex_review_status": "provisionally_accepted_for_algorithm_test_only",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Expressions & Order of Operations",
    "kc_id": "7c147ca4-23b5-4563-be98-cd0b07af6f6e",
    "question": "Bỏ dấu ngoặc: 15 - (a - 4 + b). Viết biểu thức sau khi bỏ ngoặc.",
    "answer_type": "short_text",
    "accepted_answers": [
      "15 - a + 4 - b",
      "15-a+4-b"
    ...
    "common_wrong_patterns": [
      {
        "pattern": "15 - a - 4 + b",
        "mode": "contains",
        "diagnosis": "Chỉ đổi dấu hạng tử đầu hoặc đổi dấu không nhất quán",
        "diagnoses_kcs": [
          "7c147ca4-23b5-4563-be98-cd0b07af6f6e"
        ]
      },
      {
        "pattern": "15 + a - 4 + b",
        "mode": "contains",
        "diagnosis": "Không hiểu dấu trừ trước ngoặc làm đổi dấu toàn bộ hạng tử",
        "diagnoses_kcs": [
          "7c147ca4-23b5-4563-be98-cd0b07af6f6e"
        ]
      }
    ...
    "flags": [
      "codex concern: item này hard/diagnostic nhưng phải có expression parser trước khi dùng thật."
    ],
    "codex_review_status": "provisionally_accepted_for_algorithm_test_only",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Integers & Order",
    "kc_id": "57767f23-fa58-4d24-a2c3-e2bc436786da",
    "question": "Sắp xếp các số -2, -9, 4, 0 theo thứ tự tăng dần. Viết dạng a < b < c < d.",
    "answer_type": "short_text",
    "accepted_answers": [
      "-9 < -2 < 0 < 4",
      "-9<-2<0<4"
    ...
    "common_wrong_patterns": [
      {
        "pattern": "-2 < -9 < 0 < 4",
        "mode": "contains",
        "diagnosis": "Tưởng số âm có giá trị lớn về độ lớn thì lớn hơn",
        "diagnoses_kcs": [
          "57767f23-fa58-4d24-a2c3-e2bc436786da"
        ]
      }
    ...
    "flags": [
      "codex concern: nên chuyển thành ordered-list input thay vì free text."
    ],
    "codex_review_status": "provisionally_accepted_for_algorithm_test_only",
    "action_notes": [
      {
  ...
  },
  {
    ...
    "cluster": "Integers & Order",
    "kc_id": "66e748f8-6756-4f7a-8232-b6a4b7d7661f",
    "question": "Nhiệt độ giảm từ 3°C xuống thấp hơn 8°C. Nhiệt độ mới là bao nhiêu °C?",
    "answer_type": "integer",
    "accepted_answers": [
      "-5"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "5",
        "mode": "exact",
        "diagnosis": "Không biểu diễn kết quả dưới 0 bằng số âm",
        "diagnoses_kcs": [
          "66e748f8-6756-4f7a-8232-b6a4b7d7661f"
        ]
      },
      {
        "pattern": "11",
        "mode": "exact",
        "diagnosis": "Cộng độ giảm thay vì trừ",
        "diagnoses_kcs": [
          "66e748f8-6756-4f7a-8232-b6a4b7d7661f"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Integers & Order",
    "kc_id": "b2dfdb0c-b3ef-47d6-bb61-a76999c50cef",
    "question": "Số đối của 15 là số nào?",
    "answer_type": "integer",
    "accepted_answers": [
      "-15"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "15",
        "mode": "exact",
        "diagnosis": "Nhầm số đối với chính số ban đầu",
        "diagnoses_kcs": [
          "b2dfdb0c-b3ef-47d6-bb61-a76999c50cef"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "25",
        "mode": "exact",
        "diagnosis": "Cộng giá trị tuyệt đối nhưng bỏ dấu âm",
        "diagnoses_kcs": [
          "c333baa7-07c9-435d-8b03-a664244d0f21"
        ]
      },
      {
        "pattern": "-11",
        "mode": "exact",
        "diagnosis": "Nhầm cộng hai số âm thành trừ giá trị tuyệt đối",
        "diagnoses_kcs": [
          "c333baa7-07c9-435d-8b03-a664244d0f21"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Number Foundations & Divisibility",
    "kc_id": "e354d061-199b-46b6-85c5-29d02b710520",
    "question": "Viết 4 ước dương của 18 theo thứ tự tăng dần đầu tiên.",
    "answer_type": "set",
    "accepted_answers": [
      "1;2;3;6"
    ],
    ...
    "common_wrong_patterns": [
      ...
      },
      {
        "pattern": "1;2;3;9",
        "mode": "exact",
        "diagnosis": "Bỏ sót 6 là ước nhỏ hơn 9",
        "diagnoses_kcs": [
          "e354d061-199b-46b6-85c5-29d02b710520"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Number Foundations & Divisibility",
    "kc_id": "e354d061-199b-46b6-85c5-29d02b710520",
    "question": "Viết 4 bội dương đầu tiên của 8 theo thứ tự tăng dần.",
    "answer_type": "set",
    "accepted_answers": [
      "8;16;24;32"
    ],
    ...
    "common_wrong_patterns": [
      ...
      },
      {
        "pattern": "0;8;16;24",
        "mode": "exact",
        "diagnosis": "Tính cả 0 dù đề yêu cầu bội dương",
        "diagnoses_kcs": [
          "e354d061-199b-46b6-85c5-29d02b710520"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Number Foundations & Divisibility",
    "kc_id": "60307175-3512-49e9-b35b-4cfe164ef42a",
    "question": "Khi chia 137 cho 12, thương và số dư là bao nhiêu? Viết dạng {thương; số dư}.",
    "answer_type": "set",
    "accepted_answers": [
      "11;5"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "11;0",
        "mode": "exact",
        "diagnosis": "Bỏ qua số dư trong phép chia có dư",
        "diagnoses_kcs": [
          "60307175-3512-49e9-b35b-4cfe164ef42a"
        ]
      },
      {
        "pattern": "12;7",
        "mode": "exact",
        "diagnosis": "Chọn thương quá lớn hoặc không kiểm tra số dư nhỏ hơn số chia",
        "diagnoses_kcs": [
          "60307175-3512-49e9-b35b-4cfe164ef42a"
        ]
      }
    ...
    "common_wrong_patterns": [
      {
        "pattern": "144",
        "mode": "exact",
        "diagnosis": "Tính BCNN thay vì ƯCLN",
        "diagnoses_kcs": [
          "9e7337f2-bf2d-42ed-b07c-cdad95b0dd14"
        ]
      },
      {
        "pattern": "6",
        "mode": "exact",
        "diagnosis": "Tìm được ước chung nhưng chưa phải lớn nhất",
        "diagnoses_kcs": [
          "9e7337f2-bf2d-42ed-b07c-cdad95b0dd14"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Data / Statistics / Probability, Non-Visual",
    "kc_id": "37f66bcc-182b-4f34-bd00-f2be0a91e83e",
    "question": "Bảng ghi số sách đọc trong tuần: An 4, Bình 7, Chi 5, Dũng 4. Tổng số sách cả bốn bạn đọc là bao nhiêu?",
    "answer_type": "integer",
    "accepted_answers": [
      "20"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "7",
        "mode": "exact",
        "diagnosis": "Chọn giá trị lớn nhất thay vì tính tổng dữ liệu",
        "diagnoses_kcs": [
          "37f66bcc-182b-4f34-bd00-f2be0a91e83e"
        ]
      },
      {
        "pattern": "5",
        "mode": "exact",
        "diagnosis": "Tính trung bình hoặc chọn giá trị giữa thay vì tổng",
        "diagnoses_kcs": [
          "37f66bcc-182b-4f34-bd00-f2be0a91e83e"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Data / Statistics / Probability, Non-Visual",
    "kc_id": "67efc576-2aee-4fb8-9620-fb56c374b796",
    "question": "Một túi có 3 bi đỏ và 2 bi xanh. Lấy ngẫu nhiên 1 viên. Xác suất lấy được bi xanh là bao nhiêu? Viết dưới dạng phân số tối giản.",
    "answer_type": "fraction",
    "accepted_answers": [
      "2/5"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "2/3",
        "mode": "exact",
        "diagnosis": "Lấy số bi xanh chia cho số bi đỏ thay vì tổng số bi",
        "diagnoses_kcs": [
          "67efc576-2aee-4fb8-9620-fb56c374b796"
        ]
      },
      {
        "pattern": "3/5",
        "mode": "exact",
        "diagnosis": "Chọn xác suất bi đỏ thay vì bi xanh",
        "diagnoses_kcs": [
          "67efc576-2aee-4fb8-9620-fb56c374b796"
        ]
      }
  ...
  },
  {
    ...
    "cluster": "Data / Statistics / Probability, Non-Visual",
    "kc_id": "6fa1eded-67e4-4274-a8a3-2e018af090fe",
    "question": "Gieo một con xúc xắc 40 lần, mặt 1 chấm xuất hiện 6 lần. Xác suất thực nghiệm của mặt 1 chấm là bao nhiêu? Viết dạng phân số tối giản.",
    "answer_type": "fraction",
    "accepted_answers": [
      "3/20"
    ],
    ...
    "common_wrong_patterns": [
      {
        "pattern": "6/40",
        "mode": "exact",
        "diagnosis": "Tính đúng tỉ số nhưng chưa rút gọn",
        "diagnoses_kcs": [
          "6fa1eded-67e4-4274-a8a3-2e018af090fe"
        ]
      },
      {
        "pattern": "1/6",
        "mode": "exact",
        "diagnosis": "Dùng xác suất lý thuyết thay vì xác suất thực nghiệm",
        "diagnoses_kcs": [
          "6fa1eded-67e4-4274-a8a3-2e018af090fe"
        ]
      }
...
export const assessmentV2GapRecords: V2GapRecord[] = [
  {
